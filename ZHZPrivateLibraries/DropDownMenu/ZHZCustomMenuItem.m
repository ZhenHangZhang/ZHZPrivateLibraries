...
@implementation ZHZCustomMenuItem
...
+ (instancetype)menuItem:(NSString *)title image:(UIImage *)image target:(id)target action:(SEL)action {
    ZHZCustomMenuItem *item = [[ZHZCustomMenuItem alloc] init:title image:image tag:0 userInfo:nil target:target action:action];
...
+ (instancetype)menuItem:(NSString *)title image:(UIImage *)image tag:(NSInteger)tag userInfo:(NSDictionary *)userInfo {
    ZHZCustomMenuItem *item = [[ZHZCustomMenuItem alloc] init:title image:image tag:tag userInfo:userInfo target:nil action:NULL];
    item.alignment = NSTextAlignmentCenter;
...
+ (instancetype)menuTitle:(NSString *)title WithIcon:(UIImage *)icon {
    ZHZCustomMenuItem *item = [[ZHZCustomMenuItem alloc] init:title image:icon tag:0 userInfo:nil target:nil action:NULL];
