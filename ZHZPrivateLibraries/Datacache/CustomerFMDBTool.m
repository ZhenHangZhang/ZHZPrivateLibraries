...
#import "CustomerFMDBTool.h"

#define SQLITE_NAME @"CustomSqlite.sqlite"

@interface CustomerFMDBTool ()
...
static CustomerFMDBTool* BGFmdb;


@implementation CustomerFMDBTool
...
+(instancetype)intance{
    if(BGFmdb == nil){
        ...
        dispatch_once(&onceToken, ^{
            BGFmdb = [[CustomerFMDBTool alloc] init];
        });
    }
    return BGFmdb;
}
