...
- (void)show {
    ...
    [UIView animateWithDuration:0.35 delay:0 usingSpringWithDamping:0.7 initialSpringVelocity:0.8 options:UIViewAnimationOptionTransitionFlipFromBottom animations:^{
