...
//
//  ZHZBackGroundAnimatedImagesView.m
//  ZHZPrivateLibraries
//
...
@interface ZHZBackGroundAnimatedImagesView ()
{
    BOOL animating;
...
@implementation ZHZBackGroundAnimatedImagesView
...
- (void)setDelegate:(id<ZHZAnimatedImagesViewDelegate>)delegate
{
