...
#import "ZHZQQRedButtomView.h"
#import <QuartzCore/QuartzCore.h>


static const CGFloat ZHZBadgeViewShadowRadius   = 1.0f;
static const CGFloat ZHZBadgeViewTextSideMargin = 8.0f;

@interface ZHZQQRedButtomView ()
...
@implementation ZHZQQRedButtomView
...
+ (void)initialize {
    ...
    if (self == [ZHZQQRedButtomView class]) {
...
+ (void)initializeSettings {
    ...
    ZHZQQRedButtomView * appearanceProxy = [ZHZQQRedButtomView appearance];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.badgeText.length) {
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetShadowWithColor(context, self.badgeShadowSize, ZHZBadgeViewShadowRadius, self.badgeShadowColor.CGColor);
...
- (void)setBadgeViewAlignment:(ZHZBadgeViewAlignment)badgeViewAlignment {
...
- (void)layoutSubviews
{
    ...
    CGFloat margin     = [self getMargin];
    CGFloat viewWidth  = MAX(_badgeMinWidth, textWidth + ZHZBadgeViewTextSideMargin + (margin * 2));
    ...
    if (self.attachView) {
        ...
        switch (self.badgeViewAlignment) {
            case ZHZBadgeViewAlignmentTopLeft:
                center.x = attachViewFrame.origin.x;
                center.y = attachViewFrame.origin.y;
                break;
            case ZHZBadgeViewAlignmentTopRight:
                center.x = attachViewFrame.origin.x + attachViewFrame.size.width;
                center.y = attachViewFrame.origin.y;
                break;
            case ZHZBadgeViewAlignmentTopCenter:
                center.x = attachViewFrame.origin.x + attachViewFrame.size.width * 0.5f;
                center.y = attachViewFrame.origin.y;
                break;
            case ZHZBadgeViewAlignmentCenterLeft:
                center.x = attachViewFrame.origin.x;
                center.y = attachViewFrame.origin.y + attachViewFrame.size.height * 0.5f;
                break;
            case ZHZBadgeViewAlignmentCenterRight:
                center.x = attachViewFrame.origin.x + attachViewFrame.size.width;
                center.y = attachViewFrame.origin.y + attachViewFrame.size.height * 0.5f;
                break;
            case ZHZBadgeViewAlignmentBottomLeft:
                center.x = attachViewFrame.origin.x;
                center.y = attachViewFrame.origin.y + attachViewFrame.size.height;
                break;
            case ZHZBadgeViewAlignmentBottomRight:
                center.x = attachViewFrame.origin.x + attachViewFrame.size.width;
                center.y = attachViewFrame.origin.y + attachViewFrame.size.height;
                break;
            case ZHZBadgeViewAlignmentBottomCenter:
                center.x = attachViewFrame.origin.x + attachViewFrame.size.width * 0.5f;
                center.y = attachViewFrame.origin.y + attachViewFrame.size.height;
                break;
            case ZHZBadgeViewAlignmentCenter:
                center.x = attachViewFrame.origin.x + attachViewFrame.size.width * 0.5f;
                center.y = attachViewFrame.origin.y + attachViewFrame.size.height * 0.5f;
                break;
            default:
