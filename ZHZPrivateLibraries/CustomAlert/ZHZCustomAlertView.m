...
@implementation ZHZCustomAlertView
...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitle:(NSString *)otherButtonTitle
{
    ...
    if (self) {
        ...
        self.appearAnimationType = ZHZAlertViewAnimationTypeDefault;
        self.disappearAnimationType = ZHZAlertViewAnimationTypeDefault;
        self.cornerRadius = 8;
...
#pragma mark -私有方法calculateFrame-
...
-(void)outsideTap:(UITapGestureRecognizer*)tap{
    if (self.shouldDismissOnOutsideTapped) {
        [self dismiss];
    }
}
#pragma mark -私有方法addThisViewToView-
...
- (void) addThisViewToView: (UIView *) view
{
    ...
    if (self.appearAnimationType == ZHZAlertViewAnimationTypeDefault)
    {
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeZoomIn)
    {
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeFadeIn)
    {
        self.alpha = 0;
        [UIView animateWithDuration:timeAppear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.alpha = 1;
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeFlyTop)
    {
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeFlyBottom)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeFlyLeft)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeFlyRight)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == ZHZAlertViewAnimationTypeNone)
    {
        [self didAppearAlertView];
    }
}
...
- (void)dismiss
{
    ...
    if (self.disappearAnimationType == ZHZAlertViewAnimationTypeDefault) {
        self.transform = CGAffineTransformIdentity;
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeZoomOut )
    {
        self.transform = CGAffineTransformIdentity;
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.transform = CGAffineTransformMakeScale(0.01, 0.01);
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeFaceOut)
    {
        self.alpha = 1;
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.alpha = 0;
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeFlyTop)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.frame = CGRectMake(self.frame.origin.x, - self.frame.size.height - 10, self.frame.size.width, self.frame.size.height);
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeFlyBottom)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeFlyLeft)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.frame = CGRectMake( - self.frame.size.width - 10, self.frame.origin.y, self.frame.size.width, self.frame.size.height);
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeFlyRight)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    else if (self.disappearAnimationType == ZHZAlertViewAnimationTypeNone)
    {
        [self removeFromSuperview];
    }
