...
#import "ZHZCustomActionSheetView.h"
#import "ZHZTools.h"
...
#define kValidStr(str) [ZHZTools validString:str]
...
@interface ZHZCustomActionSheetView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ZHZCustomActionSheetView {
    ZHZCustomActionSheetItemClickHandle _clickHandle;
    ZHZCustomActionSheetItemClickHandle _dismissHandle;
}
...
+ (instancetype)actionSheetWithCancelTitle:(NSString *)cancelTitle alertTitle:(NSString *)alertTitle SubTitles:(NSString *)title,...NS_REQUIRES_NIL_TERMINATION {
    ZHZCustomActionSheetView *sheet = [[ZHZCustomActionSheetView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)];
