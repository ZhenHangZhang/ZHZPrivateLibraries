...
@interface ZHZPickView ()<UIPickerViewDelegate, UIPickerViewDataSource>
...
{
    ZHZPickView *pickerView = [[ZHZPickView alloc]initWithFrame:[UIScreen mainScreen].bounds  andTitle:title andHeadTitle:headTitle];
...
-(void)setupUI
{
    ...
    //  标题
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2-75, 5, 150, 20)];
    ...
    cancelButton.frame = CGRectMake(2, 5, SCREEN_WIDTH*0.2, 20);
    ...
    doneButton.frame = CGRectMake(SCREEN_WIDTH-SCREEN_WIDTH*0.2-2, 5, SCREEN_WIDTH*0.2, 20);
    ...
    //选择器
    UIPickerView *pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(5,22, SCREEN_WIDTH-10, 230)];
    ...
    [self setFrame:CGRectMake(0, SCREEN_HEIGHT-300, SCREEN_WIDTH , 300)];
