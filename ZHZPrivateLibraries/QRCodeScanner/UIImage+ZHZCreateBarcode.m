...
#import "UIImage+ZHZRoundRectImage.h"


@implementation UIImage (ZHZCreateBarcode)
...
+(UIImage*)ZHZ_imageOfRoundRectWithImage:(UIImage *)image size:(CGSize)size radius:(CGFloat)radius{
    ...
    return  [self imageOfRoundRectWithImage:image size:size radius:radius];
}
