...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [self.collectionView registerClass:[CalendarCell class] forCellWithReuseIdentifier:ZMIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    CalendarCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ZMIdentifier forIndexPath:indexPath];
